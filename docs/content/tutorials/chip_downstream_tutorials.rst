...
.. toctree::
   ...
   Detection of differential binding sites using DiffBind local and annotation with ChIPpeakAnno <diffBind/lab-diffBinding-local.rst>
   Detection of differential binding sites using DiffBind remote <diffBind/lab-diffBinding-remote.rst>
